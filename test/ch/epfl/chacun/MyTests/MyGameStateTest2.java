...
public class MyGameStateTest2 {
    ...
    void endGameWorksWithFireAndPitTrap(){
        ...
        assertEquals(messageBoardExpected.messages().get(0), gameState18.messageBoard().messages().get(0));
        assertEquals(messageBoardExpected.messages().get(1), gameState18.messageBoard().messages().get(1));
        assertEquals(messageBoardExpected.messages().get(4), gameState18.messageBoard().messages().get(4));
        if (messageBoardExpected.messages().get(2).equals(gameState18.messageBoard().messages().get(2))) {
            assertEquals(messageBoardExpected.messages().get(3), gameState18.messageBoard().messages().get(3));
        } else if (messageBoardExpected.messages().get(2).equals(gameState18.messageBoard().messages().get(3))) {
            assertEquals(messageBoardExpected.messages().get(3), gameState18.messageBoard().messages().get(2));
        } else {
            fail();
        }
    ...
    void endGameWorksWithPitTrap(){
        ...
        assertEquals(messageBoardExpected.messages().get(0), gameState13.messageBoard().messages().get(0));
        assertEquals(messageBoardExpected.messages().get(3), gameState13.messageBoard().messages().get(3));
        if (messageBoardExpected.messages().get(1).equals(gameState13.messageBoard().messages().get(1))) {
            assertEquals(messageBoardExpected.messages().get(2), gameState13.messageBoard().messages().get(2));
        } else if (messageBoardExpected.messages().get(1).equals(gameState13.messageBoard().messages().get(2))) {
            assertEquals(messageBoardExpected.messages().get(2), gameState13.messageBoard().messages().get(1));
        } else {
            fail();
        }
